...
export function SignupForm({
  ...
  const firstFieldError = Object.values(errors.fields).find(
  ...
  async function onSubmitCode(e: React.SyntheticEvent<HTMLFormElement>) {
    e.preventDefault();
    if (isFetching) return;
    setLocalError(null);
  ...
  async function onOAuth(strategy: "oauth_apple" | "oauth_google") {
    if (isFetching) return;
    setLocalError(null);
    await signUp.sso({
      strategy,
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <FieldGroup>
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              >
                ...
                <span className="sr-only">Looklens</span>
              </a>
              <h1 className="text-xl font-bold">Welcome to Looklens</h1>
              <FieldDescription>
      ...
      <FieldDescription className="px-6 text-center">
        ...
        <a href="/term">Terms of Service</a> and <a href="#">Privacy Policy</a>.
      </FieldDescription>
    </div>
  );
}
